...
class GenerateCreateView extends Command
{
     ...
     * @var string
     */
    protected $signature = 'app:viewCreate {model}';
    ...
    public function handle()
    {
        ...
        $this->info("Create view generated for model: $model");
    }
    ...
    protected function generateInputContent($inputType, $property)
    {
        if ($inputType === 'textarea') {
            ...
            return <<<HTML
                                    ...
                                    <div class="form-group mb-3">
                                        <label for="$property" class="@if (\$errors->has('$property')) text-danger @endif">{{ __('labels.$property') }}</label>
                                        <input type="file" id="$property" name="$property" class="form-control @if (\$errors->has('$property')) is-invalid @endif" required>
                                    </div>
                HTML;
